...
const sliderApp = {
  init() {
    ...
    const configPanel1 = new ConfigPanel(this.setElements({
    ...
    const configPanel2 = new ConfigPanel(this.setElements({
    ...
    const configPanel3 = new ConfigPanel(this.setElements({
    ...
    const configPanel4 = new ConfigPanel(this.setElements({
  ...
  setElements(panelIds: PanelIds): PanelElements {
    return ({
      firstValue: <HTMLInputElement>document.getElementById(panelIds.firstValue),
      secondValue: <HTMLInputElement>document.getElementById(panelIds.secondValue),
      ...
      verticalMode: <HTMLInputElement>document.getElementById(panelIds.verticalMode),
      isValueVisible: <HTMLInputElement>document.getElementById(panelIds.isValueVisible),
    });
  },
};
